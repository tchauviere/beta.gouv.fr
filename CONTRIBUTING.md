...
- Une vidéo peut également être ajoutée. Pour cela, ajouter une vidéo en MP4 [optimisée pour le web](https://rigor.com/blog/2016/01/optimizing-mp4-video-for-fast-streaming) du nom du fichier de description de la startup dans le dossier `video`. La vidéo devrait être en 720p (1280 ⨉ 720 pixels).
